...
MEMORY
    ...
    SRAM (wx) : ORIGIN = 0x20000000, LENGTH = 0x10000
    IDT_LIST (wx) : ORIGIN = (0x20000000 + 0x10000), LENGTH = 2K
    }
ENTRY("__start")
SECTIONS
    {
 ...
 *(".kernel_noinit.*")
    ...
    _image_ram_end = .;
    _end = .;
    __kernel_ram_end = 0x20000000 + 0x10000;
...
.gnu.sgstubs :
{
 . = ((ALIGN(0x8000) - MAX(32, (1 << LOG2CEIL(__sg_size)))) + ((ABSOLUTE(.) > (ALIGN(0x8000) - MAX(32, (1 << LOG2CEIL(__sg_size))))) ? 0x8000 : 0));
 __sg_start = .;
} > FLASH
__sg_end = .;
