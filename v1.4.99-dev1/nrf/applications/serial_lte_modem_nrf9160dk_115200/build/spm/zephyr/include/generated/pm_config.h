...
#define PM_NUM 8
#define PM_ALL_BY_SIZE "mcuboot_pad otp EMPTY_0 mcuboot spm bsdlib_sram spm_sram sram_secure sram_primary app mcuboot_primary_app mcuboot_secondary mcuboot_primary"
